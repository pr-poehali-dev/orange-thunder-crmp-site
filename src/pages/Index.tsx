            ...
            <div className="flex items-center justify-between px-6 py-5" style={{ borderBottom: "1px solid rgba(255,107,0,0.15)", background: "linear-gradient(135deg, rgba(255,107,0,0.08), transparent)" }}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div style={{ color: "#B0A898", fontSize: 12 }}>Игрок: DragonSlayer_RUS</div>
                </div>
              </div>
            ...
            <div className="p-6">
              <div className="rounded-xl p-4 mb-5" style={{ background: "rgba(255,107,0,0.06)", border: "1px solid rgba(255,107,0,0.15)" }}>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span style={{ fontFamily: "Oswald", fontSize: 22, fontWeight: 700, color: "var(--orange)" }}>LVL 47</span>
                </div>
                <div className="w-full rounded-full h-2.5 mb-1" style={{ background: "rgba(255,255,255,0.08)" }}>
                  <div className="h-2.5 rounded-full" style={{ width: "72%", background: "linear-gradient(90deg, var(--orange), #FF8C00)" }} />
                </div>
                <div style={{ color: "#B0A898", fontSize: 12 }}>14 200 / 20 000 XP до следующего уровня</div>
              </div>

              <div className="grid grid-cols-3 gap-3 mb-5">
                {[
                  { label: "Баланс", val: "$127 500", icon: "DollarSign" },
                  { label: "Часов", val: "342 ч", icon: "Clock" },
                  { label: "Рейтинг", val: "#234", icon: "TrendingUp" },
                ].map((s) => (
              ...
              <div className="flex flex-col gap-2">
                {[
                  { text: "Выполнено задание «Ограбление банка»", time: "2 часа назад", icon: "CheckCircle" },
                  { text: "Куплен транспорт: BMW M5", time: "Вчера", icon: "Car" },
                  { text: "Получен ежедневный бонус ×4", time: "4 дня подряд", icon: "Gift" },
                ].map((h, i) => (
